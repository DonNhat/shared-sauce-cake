...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2022 at 09:36 AM
...
--
-- RELATIONS FOR TABLE `doctor_users`:
--
...
--
-- RELATIONS FOR TABLE `extrainfos`:
--
...
--
-- RELATIONS FOR TABLE `sequelizemeta`:
--
...
--
-- RELATIONS FOR TABLE `specializations`:
--
...
--
-- RELATIONS FOR TABLE `supporterlogs`:
--
